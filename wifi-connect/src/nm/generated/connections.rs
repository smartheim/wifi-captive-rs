...
pub trait Settings {
    ...
    fn add_connection(&self, connection: ::std::collections::HashMap<&str, ::std::collections::HashMap<&str, arg::Variant<Box<dyn arg::RefArg>>>>) -> nonblock::MethodReply<dbus::Path<'static>>;
    fn add_connection_unsaved(&self, connection: ::std::collections::HashMap<&str, ::std::collections::HashMap<&str, arg::Variant<Box<dyn arg::RefArg>>>>) -> nonblock::MethodReply<dbus::Path<'static>>;
