...
pub trait Connection {
    fn update(&self, properties: ::std::collections::HashMap<&str, ::std::collections::HashMap<&str, arg::Variant<Box<dyn arg::RefArg>>>>) -> nonblock::MethodReply<()>;
    fn update_unsaved(&self, properties: ::std::collections::HashMap<&str, ::std::collections::HashMap<&str, arg::Variant<Box<dyn arg::RefArg>>>>) -> nonblock::MethodReply<()>;
    fn delete(&self) -> nonblock::MethodReply<()>;
    fn get_settings(&self) -> nonblock::MethodReply<::std::collections::HashMap<String, ::std::collections::HashMap<String, arg::Variant<Box<dyn arg::RefArg + 'static>>>>>;
    fn get_secrets(&self, setting_name: &str) -> nonblock::MethodReply<::std::collections::HashMap<String, ::std::collections::HashMap<String, arg::Variant<Box<dyn arg::RefArg + 'static>>>>>;
    fn clear_secrets(&self) -> nonblock::MethodReply<()>;
    fn save(&self) -> nonblock::MethodReply<()>;
    fn update2(&self, settings: ::std::collections::HashMap<&str, ::std::collections::HashMap<&str, arg::Variant<Box<dyn arg::RefArg>>>>, flags: u32, args: ::std::collections::HashMap<&str, arg::Variant<Box<dyn arg::RefArg>>>) -> nonblock::MethodReply<::std::collections::HashMap<String, arg::Variant<Box<dyn arg::RefArg + 'static>>>>;
...
impl<'a, T: nonblock::NonblockReply, C: ::std::ops::Deref<Target=T>> Connection for nonblock::Proxy<'a, C> {
    ...
    fn unsaved(&self) -> nonblock::MethodReply<bool> {
        <Self as nonblock::stdintf::org_freedesktop_dbus::Properties>::get(&self, "org.freedesktop.NetworkManager.Settings.Connection", "Unsaved")
    }

    fn flags(&self) -> nonblock::MethodReply<u32> {
        <Self as nonblock::stdintf::org_freedesktop_dbus::Properties>::get(&self, "org.freedesktop.NetworkManager.Settings.Connection", "Flags")
    }

    fn filename(&self) -> nonblock::MethodReply<String> {
        <Self as nonblock::stdintf::org_freedesktop_dbus::Properties>::get(&self, "org.freedesktop.NetworkManager.Settings.Connection", "Filename")
    }
}
